...
replace go-core/7-lesson/pkg/builder v0.0.0 => ../../pkg/builder

replace go-core/7-lesson/pkg/engine v0.0.0 => ../../pkg/engine
...
require (
	go-core/7-lesson/pkg/builder v0.0.0
	go-core/7-lesson/pkg/engine v0.0.0
